# ruff: noqa
# Source: https://github.com/wayne155/pytorch_timeseries
# File: torch_timeseries/nn/attention.py — reproduced verbatim, pure PyTorch.
...
class FullAttention(nn.Module):
    def __init__(self, mask_flag: bool = True, scale: float = None, attention_dropout: float = 0.1):
