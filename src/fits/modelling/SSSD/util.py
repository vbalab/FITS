...
# File: src/utils/util.py (subset)
# Reproduced verbatim. Only the five functions required by the adapter and
# SSSDS4Imputer are included; dataset-masking utilities (get_mask_*) and
# checkpoint helpers are omitted as they are not used in this codebase.
import numpy as np
import torch
